...
<html lang="en">
	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="padding-bottom: 15px; padding-top: 10px;"><img src="https://profitley.com/email-templates/images/softude.png" alt="profitley"></td>
				</tr>						
			</tbody>
		</table>
			...
			<tbody>
				<tr>
					...
					<td style="background: #0048BA; padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
						<table>
							<tr>
								<td style="font-family: arial; font-size: 32px; font-weight: 700; color: #fff;">Order Invoiced</td>
							</tr>
							<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				...
				<tr>
					<td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">Your order has been invoiced. Below are invoice details.</td>
				</tr>						
			</tbody>
		</table>
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Invoice #:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">{{ $invoice->code }}</td>
				</tr>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Invoice Date:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">{{ date('d M, Y',strtotime($invoice->invoice_date)) }}</td>
				</tr>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Invoice Amount:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">₹ {{ $invoice->total }}</td>
				</tr>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Tax:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">₹ 0.00</td>
				</tr>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Sub Total:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">₹ {{ $invoice->sub_total }}</td>
				</tr>
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">Grand Total:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding-top:5px; padding-bottom:5px; font-weight: 600">₹ {{ $invoice->total }}</td>
				</tr>
				<tr>
