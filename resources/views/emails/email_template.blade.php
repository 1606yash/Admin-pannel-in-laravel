...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td style="background: #0048BA; padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
                        <table>
                            <tr>
                                <td style="font-family: arial; font-size: 32px; font-weight: 700; color: #fff;">{{ $mailSubject }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                <tr>
                    <td style="font-family: Arial, Helvetica, sans-serif; padding-bottom: 10px;">{!! $body !!}</td>
                </tr>
            </tbody>
        </table>
        <!-- content Area End -->
