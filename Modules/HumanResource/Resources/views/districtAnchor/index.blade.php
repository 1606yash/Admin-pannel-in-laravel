...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h5 class="nk-block-title page-title">District Anchors</h5>
        </div>
        <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-primary nav-link mr-2" href="{{ url('/human-resource/employees/district-anchor/add-user') }}"><em class="icon ni ni-plus" style="color: #fff;"></em><span>Add District Anchor</span></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="nk-add-product toggle-slide toggle-slide-right" data-content="filterUser" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar id="filterUser">
    <form action="#" role="form" class="mb-0" method="get" id="filterUserForm">
        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title modalTitle">District Anchor Filter</h5>
            </div>
        </div>
        <div class="nk-block">
            <div class="row g-3">
...
<script type="text/javascript">
    ...
    function loadAllDistrictDataTable() {
        ...
        dt = new CustomDataTable({
            ...
            option: {
                ...
                ajax: {
                    type: "GET",
                    url: "{{ url('/human-resource/employees/district-anchor/get-district-anchors') }}",
                },
                columns: [{
    ...
    $('.brand-init').on('click', '.view-user', function(e) {
        var id = $(this).attr('data-id');
        window.location.href = root_url + `/human-resource/employees/district-anchor/view-user/${id}`;
    });


    $(document).ready(function() {
        var root_url = "<?php echo Request::root(); ?>";
        loadAllDistrictDataTable();
