...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h5 class="nk-block-title page-title">Attendants</h5>
        </div>
        <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                        <li class="nav-item">
                            <a class="btn btn-primary nav-link mr-2" href="{{ url('/human-resource/employees/attendant/add-user') }}"><em class="icon ni ni-plus" style="color: #fff;"></em><span>Add Attendant</span></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="toggle-bar">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#all-attendents" data-tab="all">All Attendant ({{$data}}) </a>
        </li>
        <li class="nav-item">
...
<div class="tab-content">
    <div class="tab-pane fade show active mt-5" id="all-attendents">
        <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
                <div class="toggle-expand-content" data-content="more-options">
        ...
        <div class="nk-add-product toggle-slide toggle-slide-right" data-content="filterUser" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar id="filterUser">
            <form action="#" role="form" class="mb-0" method="get" id="filterUserForm">
                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        <h5 class="nk-block-title modalTitle">Attendant Filter</h5>
                    </div>
                </div>
                <div class="nk-block">
                    <div class="row g-3">
...
<script type="text/javascript">
    ...
    function loadAllAttendantsDataTable() {
        ...
        dt = new CustomDataTable({
            ...
            option: {
                ...
                ajax: {
                    type: "GET",
                    url: "{{ url('/human-resource/employees/attendant/get-attendants') }}",
                },
                columns: [{
    ...
    function loadPendingRequestAttendantsDataTable() {
        ...
        st = new CustomDataTable({
            ...
            option: {
                ...
                ajax: {
                    type: "GET",
                    url: "{{ url('/human-resource/employees/attendant/get-attendants-pending-request') }}",
                },
                columns: [{
                        "class": "nk-tb-col tb-col-lg",
                        data: 'user_name',
    ...
    $(document).ready(function() {
                        ...
                        success: function(data) {
                            ...
                            if (data.success) {
                                Swal.fire('', 'User/Account Approved',
                                    'success');
                                loadAllAttendantsDataTable();
                                loadPendingRequestAttendantsDataTable();
                                location.reload()
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $('.brand-init').on('click', '.view-user', function(e) {
            var id = $(this).attr('data-id');
            window.location.href = root_url + `/human-resource/employees/attendant/view-user/${id}`;
        });
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                console.log(data);
                                if (data.success) {
                                    loadAllAttendantssDataTable();
                                    loadPendingRequestAttendantssDataTable();
                                } else {
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Oops...',
