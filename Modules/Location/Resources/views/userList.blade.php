                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                                    <ul class="link-check">
                                        ...
                                        <li><a href="{{ url('location/city/import') }}"><em class="icon ni ni-upload m-r10"></em> Import</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nk-block-tools-opt">
                            <a href="#" data-target="addCity" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add City</span></a>
                        </li>
                        @endif
                    </ul>
                </div>
...
<div class="nk-block table-compact">
    ...
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addCity" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar id="modal">
        <form role="form" method="post" id="addCityForm" action="{{ url('location/city/add') }}" enctype="multipart/form-data">
            @csrf
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if (arr.length == 0) {
            ...
            $.ajax({
                url: root_url + '/location/city/mass-update',
                data: {
                    'ids': arr,
                    'status': status
                },
    ...
    $(function() {
        ...
        $('.brand-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/location/city/get-city',
                data: {
                    'id': id
                },
                //dataType: "html",
        ...
        $('.brand-init').on('click', '.eg-swal-av3', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: root_url + '/location/city/delete',
                        data: {
                            'id': id
                        },
                        //dataType: "html",
    ...
    $('#country_id').on("change", function() {
        ...
        $.ajax({
            url: root_url + '/location/city/get-states',
            data: {
