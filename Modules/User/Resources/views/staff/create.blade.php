...
@section('content')
    ...
    <form role="form" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-9">
                        <div class="sp-plan-info card-inner">
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <select class="form-select" multiple="" data-placeholder="Select Organization" data-parsley-errors-container=".proCatParsley" name="organization[]" required="" id="organization">
        ...
        @else
        <input type="hidden" name="organization" id="organization" value="{{ $currentOrganization }}">
        @endif
                    ...
                    <div class="col-md-3">
                        <div class="sp-plan-action card-inner">
                            <div class="icon">
                                ...
                                <h6 class="o-5">Buyer Information</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="sp-plan-info card-inner">
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.text value="{{ isset($user) ? $user->shop_name : old('shopname') }}" for="shopName" icon="building" required="true" placeholder="Shop Name" name="shopname" class="buyerFileds" disabled/>
                            ...
                            <div class="row g-3 align-center">
                                <div class="col-lg-5">
                                    <x-inputs.verticalFormLabel label="GST" for="gst" suggestion="Specify the GST number of the user." required="true" />
                                </div>
                                <div class="col-lg-7">
                                    <x-inputs.text value="{{ isset($user) ? $user->gst : old('gst') }}" for="gst" icon="notes-alt" required="true" placeholder="GST Number" name="gst" class="buyerFileds" />
                                    @if ($errors->has('gst'))
                            ...
                            <div class="row g-3 align-center">
                                <div class="col-lg-5">
                                    <x-inputs.verticalFormLabel label="Credit Limit" for="creditLimit" suggestion="Specify the credit limit of the user." required="true" />
                                </div>
                                <div class="col-lg-7">
                                    <x-inputs.text value="{{ isset($user) ? $user->credit_limit : old('creditLimit') }}" for="creditLimit" icon="sign-inr" required="true" placeholder="Credit Limit" name="creditLimit" class="buyerFileds" />
                                    @if ($errors->has('creditLimit'))
                                        <span class="text-danger">{{ $errors->first('creditLimit') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.select  size="md" name="category" for="category"  class="buyerFileds" >
                                        ...
                                        @if(isset($user) && $user->retailer_catagory == $category->id)
                                        selected
                                        @elseif(old('category') == $category->id) 
                                        selected
                                        @endif

                                        value="{{ $category->id }}">{{ $category->retailer_catagory }}</option>
                                    @endforeach
                                    </x-inputs.select>
            ...
            <div class="card card-bordered sp-plan">
                <div class="row no-gutters">
                    <div class="col-md-3">
                        <div class="sp-plan-action card-inner">
                            <div class="icon">
                                <h6 class="o-5">Address Information</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    @if(isset($user) && $user->district)
                                        @foreach ($districts as $key => $district)
                                            <option 
                                            @if(isset($user) && $user->district == $district->id)
                                            selected
                                ...
                                <div class="col-lg-7">
                                    ...
                                    @if(isset($user) && $user->city)
                                        @foreach ($cities as $key => $city)
                                            <option 
                                            @if(isset($user) && $user->city == $city->id)
                                            selected
        ...
        @endif
        <div class="nk-block brandsBox" style="display: none;">
            <div class="card card-bordered sp-plan">
                <div class="row no-gutters">
                    <div class="col-md-3">
                        <div class="sp-plan-action card-inner">
                            <div class="icon">
                                <h6 class="o-5">Assign Brands</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
    ...
    <input type="hidden" name="mappedBrands" id="mappedBrands" value="@if(isset($user)){{ implode(',', $mappedBrands) }}@endif">
