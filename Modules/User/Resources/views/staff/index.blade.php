                    ...
                    <div class="gy-3">
                        ...
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-lg-7">
                                @php
                                    $lastname="";
                                    if(isset($filterRequests['lastname']))
                                        $lastname=$filterRequests['lastname'];
                                @endphp
                                <x-inputs.text value="{{ $lastname }}" for="lastName" icon="user" placeholder="Last name" name="lastname" />
                            </div>
                        </div>
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
